...
/**
 * Class Clearpay_Clearpay_Helper_Checkout
 *
 ...
 * in that class.
 */
class Clearpay_Clearpay_Helper_Checkout extends Mage_Checkout_Helper_Url
{
    /**
    ...
    public function noConflict()
    {
        ...
        return $currency == $base && in_array($currency, Clearpay_Clearpay_Model_Method_Base::SUPPORTED_CURRENCIES);
    }
}
