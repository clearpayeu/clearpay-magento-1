...
/**
 * Class Clearpay_Clearpay_Model_Api_Adapters_Adapterv1
 *
...
class Clearpay_Clearpay_Model_Api_Adapters_Adapterv1
{
    ...
    /**
     * @return Clearpay_Clearpay_Model_Api_Router
     */
    public function getApiRouter()
    {
        return Mage::getModel('clearpay/api_routers_routerv1');
    }

    public function buildOrderTokenRequest($object, $override = array(), $clearpayPaymentTypeCode = NULL)
    {
    ...
    {
        if ($quote->getData('clearpay_express_checkout')) {
            $params = array(
                'amount' => json_decode($quote->getData('clearpay_express_amount'), true),
                'isCheckoutAdjusted' => true,
                'shipping' => json_decode($quote->getData('clearpay_express_shipping'), true),
            );
        } else {
            $params = array();
        }
