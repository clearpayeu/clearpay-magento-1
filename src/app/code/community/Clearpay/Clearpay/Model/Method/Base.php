...
abstract class Clearpay_Clearpay_Model_Method_Base extends Mage_Payment_Model_Method_Abstract
{
    ...
    const SUPPORTED_CURRENCIES = ['GBP'];
    ...
    {
        $ids = Mage::getStoreConfig('payment/clearpaypayovertime/restricted_categories');
        return explode(',', $ids);
    }
    ...
    protected function _sendRequest($url, $body = false, $method = 'GET', $call = null)
    {
        ...
        $client = new Clearpay_Clearpay_Model_Api_Http_Client($url);
