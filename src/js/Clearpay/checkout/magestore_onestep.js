...
(function() {
    if (typeof window.oscPlaceOrder !== 'undefined') {
        ...
        window.oscPlaceOrder = function (element) {
            ...
            if (validator.validate() && $('p_method_clearpaypayovertime') && $('p_method_clearpaypayovertime').checked) {
                ...
                /**
                 * Perform ajax to Clearpay to get order token
                 */
                new Ajax.Request(
